                ...
                <div class="card-body">
                    ...
                    <form action="{{route('blog.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" value="home.tech" placeholder="Tag" name="tags"
                                       id="tags" data-role="tagsinput">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <button class="btn btn-success btn-rounded waves-effect waves-light" type="submit">Blog Category create</button>
                    </form>
                </div>
            </div>
        </div> <!-- end col -->

                ...
                <div class="card-body">
                    ...
                    <form action="{{route('blog.update',$blog->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" placeholder=" Title" name="title" value="{{$blog->title}}"
                                       id="title" >
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text"  placeholder="Tag" name="tags"
                                       id="tags" data-role="tagsinput" value="{{$blog->tags}}">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <button class="btn btn-success btn-rounded waves-effect waves-light" type="submit">Blog Category Update</button>
                    </form>
                </div>
            </div>
        </div> <!-- end col -->
